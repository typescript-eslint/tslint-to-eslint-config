...
> 🙏 [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) is an excellent ESLint configuration that disables formatting rules from your configuration.
> Please use it. 🙏
